...
struct wlr_scene {
	...
	struct wl_list fifo_surfaces; // list of fifo'ed wlr_surfaces
	...
	struct {
		...
		struct wl_listener fifo_manager_v1_fifo_destroy;
		struct wl_listener fifo_manager_v1_new_fifo;
		struct wl_listener fifo_manager_v1_fifo_barrier;
